...
//using BO;
///// <summary>
///// A simulation class using BackgroundWorker for the drone status
///// </summary>
//namespace PL
//{
//    public class SimulationOfDrone
//    {
//        public BO.Drone MyDrone { get; set; }
//        public BackgroundWorker worker { get; set; }
//        public SimulationOfDrone(BO.Drone drone)
//        {
//            MyDrone = drone;
//            worker = new();
...
//            if (reful && ok)
//                counter = (int)MyDrone.DroneBattery;
//            while (counter != 100)
//            {
